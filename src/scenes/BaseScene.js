...
/**
 * BaseScene — Base class for all standalone scenes.
 * Enforces explicit lifecycle:
...
export class BaseScene {
   ...
   * Guarantees zero memory leaks between scenes.
   */
  dispose() {
    this.exit();

    // 1. Clear ECS world and entities
    this.ecsWorld.clear();
    ...
    for (const cleanup of this.cleanups) {
      try {
        ...
        console.warn(`[BaseScene:${this.id}] Error in cleanup:`, err);
      }
    }
    this.cleanups = [];
  }
